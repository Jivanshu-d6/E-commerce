      ...
      <div className="row ">
        ...
        <div className="col-md-4">
          <p className="text-justify mt-2">
            ...
            ecommerce website, , created using the MERN stack: Welcome to
            EVShop! At EVShop, we believe that shopping should be more than just a
            ...
            EVShop is your one-stop destination for all your shopping needs.
            ...
            you find exactly what you're looking for, every time. But EVShop is
            ...
            trust that EVShop has your best interests at heart. Thank you for
            choosing EVShop. We're honored to be a part of your shopping
            experience, and we look forward to serving you for years to come.
            Happy shopping! The EVShop Team
          </p>
        </div>
      </div>
    </Layout>
